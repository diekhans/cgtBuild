...
# usage:
#  env = Environment(tools=['default', 'textfile', 'symlink'], toolpath=["btools/lib/scons"])
#  env.SymLink("./lib/py/cgt/sonLib", "#/mods/sonLib/py/cgt/sonLib")


# from http://stackoverflow.com/questions/3532307/how-to-create-a-symbolic-link-with-scons
# needed to add check for symlink existing, as sometimes scons decides to call it even
# if it exists

# FIXME: then got this error, causes by FS.py check
# TypeError: Directory /cluster/home/markd/compbio/compartiveGenomics/projs/springClean/src/cgtBuild/build/sonLib/lib/py/cgt/sonLib found where file expected.:
